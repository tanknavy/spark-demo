...
public class ConsumerDemoWithThread3 {
    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger(ConsumerDemoWithThread3.class.getName());
        ...
        // 第二种方法呢?
        ConsumerDemoWithThread3 consumerDemoWithThread3 = new ConsumerDemoWithThread3();
        //Runnable myConsumer = new ConsumerThread(latch,bootstrapServers,groupId,topic);
        // 第三种方法
        Runnable myConsumer = new ConsumerDemoWithThread3().new ConsumerThread(latch,bootstrapServers,groupId,topic);
