...
/**
 * Author: Alex Cheng 7/14/2020 8:40 PM
 */
public class InterceptorProducer {
    public static void main(String[] args) {
        ...
        //使用自定义拦截器，拦截器链
        List<String> interceptors = Arrays.asList("com.tanknavy.interceptor.TimeInterceptor", "com.tanknavy.interceptor.CounterInterceptor");
